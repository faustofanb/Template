...
(
    ...
    `order_sn`       varchar(64) COLLATE utf8mb4_general_ci  DEFAULT NULL COMMENT '订单号',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='乘车人订单关系表';
