...
import fausto.fan.project.framework.starter.base.SingletonObjectPool
...
class StringRedisTemplateProxy(
    ...
    override fun safePut(
        ...
        put(key, value, timeout, actualTimeUnit)
    ...
    override fun putIfAllAbsent(keys: Collection<String>): Boolean {
        ...
        val actual = SingletonObjectPool.get(LUA_PUT_IF_ALL_ABSENT_SCRIPT_PATH) {
